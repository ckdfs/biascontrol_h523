...
| [spec-03-mzm-quad](docs/plan/spec-03-mzm-quad.md) | ✅ 已完成（阶段基线） | 上一阶段 MZM 全范围控制基线：DC-assisted QUAD 路径与 5 min 套测 |
| [spec-04-mzm-no-dc-5hz](docs/plan/spec-04-mzm-no-dc-5hz.md) | 🔄 进行中 | 5 Hz、双扫描、全工作点无 DC 主控制重构 |
| [spec-05-robustness](docs/plan/spec-05-robustness.md) | ⏳ 待实现 | 长期稳定性、扰动恢复、参数持久化与整定接口 |
| [spec-06-multi-modulator](docs/plan/spec-06-multi-modulator.md) | 🔮 未来 | DDMZM、DPMZM、DPQPSK、PM 多调制器支持 |
...
| MZM 闭环控制基线 | [docs/plan/spec-03-mzm-quad.md](docs/plan/spec-03-mzm-quad.md) | 上一阶段 MZM 全范围控制基线与验证结果 |
| 5 Hz 无 DC 控制 | [docs/plan/spec-04-mzm-no-dc-5hz.md](docs/plan/spec-04-mzm-no-dc-5hz.md) | 当前计划中的双扫描、5 Hz、无 DC 主控制替换方案 |
| 鲁棒性与持久化 | [docs/plan/spec-05-robustness.md](docs/plan/spec-05-robustness.md) | 长期稳定性、UART 整定接口、参数持久化 |
| 多调制器扩展 | [docs/plan/spec-06-multi-modulator.md](docs/plan/spec-06-multi-modulator.md) | DDMZM / DPMZM / DPQPSK / PM 规划 |
